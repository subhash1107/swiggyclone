...
const OnlineDelivery = () => {
    ...
    return (
        <div className="max-w-[1200px] mb-16 mx-auto">
            <div ref={titleRef} className="text-[25px] px-2 font-bold my-2">Restaurants with online food delivery in Badarpur</div>
            <div 
                ref={componentRef}
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center gap-3 mx-auto">
                {data.map((val, index) => (
                    <RestCard
                        key={index}
